...
bool won(Board *b) {
  if  ((b->cells[0][0] == b->cells[0][1]) &&  (b->cells[0][0] == b->cells[0][2]) &&(b->cells[0][0] != B)) return true;
  if  ((b->cells[1][0] == b->cells[1][1]) &&  (b->cells[1][0] == b->cells[1][2]) &&(b->cells[1][0] != B)) return true;
  if  ((b->cells[2][0] == b->cells[2][1]) &&  (b->cells[2][0] == b->cells[2][2]) &&(b->cells[2][0] != B)) return true;
  if  ((b->cells[0][0] == b->cells[1][0]) &&  (b->cells[0][0] == b->cells[2][0]) &&(b->cells[0][0] != B)) return true;
  if  ((b->cells[0][1] == b->cells[1][1]) &&  (b->cells[0][1] == b->cells[2][1]) &&(b->cells[0][1] != B)) return true;
  if  ((b->cells[0][2] == b->cells[1][2]) &&  (b->cells[0][2] == b->cells[2][2]) &&(b->cells[0][2] != B)) return true;
  if  ((b->cells[0][0] == b->cells[1][1]) &&  (b->cells[0][0] == b->cells[2][2]) &&(b->cells[0][0] != B)) return true;
  if  ((b->cells[0][2] == b->cells[1][1]) &&  (b->cells[0][2] == b->cells[2][0]) &&(b->cells[0][2] != B)) return true;
  else {
    return false;
  }
}
...
bool drawn(Board *b) {
  if ((full(b) == true) && (won(b) == false)) return true;
    else return false;
}
